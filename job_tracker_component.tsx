            ...
            <div style={{ display: "flex", gap: 6, marginBottom: 12, flexWrap: "wrap" }}>
              {filterStage !== "all" && (
                <span style={{
                  ...
                  <button onClick={() => setFilterStage("all")} aria-label="Clear stage filter" title="Clear stage filter" style={{ background: "none", border: "none", cursor: "pointer", color: "inherit", padding: 0, lineHeight: 1 }}>×</button>
                </span>
              )}
              {sortField !== "none" && (
                <span style={{
        ...
        <Modal onClose={() => setSelectedApp(null)} t={t}>
          <div style={{ padding: "20px 24px" }}>
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 20 }}>
              ...
              <button onClick={() => setSelectedApp(null)} aria-label="Close application details" title="Close" style={{ background: "none", border: "none", cursor: "pointer", color: t.muted }}>
                <XIcon />
              </button>
            </div>
        ...
        <Modal onClose={() => setEditApp(null)} t={t}>
          <div style={{ padding: "20px 24px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
              ...
              <button onClick={() => setEditApp(null)} aria-label="Close edit modal" title="Close" style={{ background: "none", border: "none", cursor: "pointer", color: t.muted }}><XIcon /></button>
            </div>
        ...
        <Modal onClose={() => setShowSettings(false)} t={t}>
          <div style={{ padding: "20px 24px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
              ...
              <button onClick={() => setShowSettings(false)} aria-label="Close settings" title="Close" style={{ background: "none", border: "none", cursor: "pointer", color: t.muted }}><XIcon /></button>
            </div>
