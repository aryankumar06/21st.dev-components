            ...
            {resumeFile
              ? <span style={{ color: t.text, display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <button
                    ...
                    aria-label="Remove resume" title="Remove resume"
            ...
            <div style={{ display: "flex", gap: 6, marginBottom: 12, flexWrap: "wrap" }}>
              ...
              {sortField !== "none" && (
                <span style={{
                  ...
                  <button onClick={clearSort} aria-label="Clear filter" title="Clear filter" style={{ background: "none", border: "none", cursor: "pointer", color: "inherit", padding: 0, lineHeight: 1 }}>×</button>
                </span>
              )}
            </div>
          )}
