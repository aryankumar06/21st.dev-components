      ...
      <div style={{ maxWidth: isExpanded ? "100%" : 1060, margin: "0 auto", position: "relative" }}>
        ...
        <section style={{ marginBottom: 52 }}>
          ...
          <label
            ...
            onFocus={() => setResumeFocus(true)}
            onBlur={() => setResumeFocus(false)}
            style={{
              display: "flex", alignItems: "center", gap: 12,
              background: t.surfaceAlt,
              border: `1px solid ${resumeFocus ? "#3b82f6" : t.border}`,
              boxShadow: resumeFocus ? "0 0 0 2px rgba(59, 130, 246, 0.5)" : "none",
              borderRadius: 8, padding: "16px 20px",
              fontSize: 14, color: t.muted, cursor: "pointer",
              transition: "border-color 0.2s, box-shadow 0.2s",
            }}
            onMouseEnter={(e) => { if (!resumeFocus) e.currentTarget.style.borderColor = "#3b82f6"; }}
            onMouseLeave={(e) => { if (!resumeFocus) e.currentTarget.style.borderColor = t.border; }}
          >
