              ...
              <div style={{ position: "relative", marginLeft: 4 }} ref={newDropdownRef}>
                <div style={{ display: "flex" }}>
                  ...
                  <button
                    ...
                    aria-label="Open add to stage dropdown"
                    title="Open add to stage dropdown"
                  >
        ...
        <Modal onClose={() => setSelectedApp(null)} t={t}>
          <div style={{ padding: "20px 24px" }}>
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 20 }}>
              ...
              <button onClick={() => setSelectedApp(null)} style={{ background: "none", border: "none", cursor: "pointer", color: t.muted }} aria-label="Close modal" title="Close modal">
                <XIcon />
              </button>
            </div>
