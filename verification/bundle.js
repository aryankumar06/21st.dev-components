      ...
      /* @__PURE__ */ jsxs("div", { className: cn("rounded-xl border shadow-xl overflow-hidden transition-colors duration-300", t.card, t.border), children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "hidden sm:block overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full border-collapse", children: [
          ...
          /* @__PURE__ */ jsxs("tbody", { children: [
            ...
            displayedHabits.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: visibleCols.length + 3, className: cn("px-5 py-10 text-center text-sm", t.muted), children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center gap-3", children: [
              /* @__PURE__ */ jsx("p", { children: "No rows match your search or filter." }),
              (searchQuery || filterConfig) && /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: () => {
                    setSearchQuery("");
        ...
        /* @__PURE__ */ jsxs("div", { className: "sm:hidden relative", children: [
          ...
          displayedHabits.length === 0 && /* @__PURE__ */ jsx("div", { className: cn("px-5 py-10 text-center text-sm", t.muted), children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center gap-3", children: [
            /* @__PURE__ */ jsx("p", { children: "No rows match your search or filter." }),
            (searchQuery || filterConfig) && /* @__PURE__ */ jsx(
              "button",
              {
