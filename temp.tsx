            ...
            <div style={{ display: "flex", gap: 6, marginBottom: 12, flexWrap: "wrap" }}>
              {filterStage !== "all" && (
                <span style={{
                  ...
                  <button onClick={() => setFilterStage("all")} style={{ background: "none", border: "none", cursor: "pointer", color: "inherit", padding: 0, lineHeight: 1 }} aria-label="Clear filter" title="Clear filter">×</button>
                </span>
              )}
              {sortField !== "none" && (
                <span style={{
        ...
        <Modal onClose={() => setSelectedApp(null)} t={t}>
          <div style={{ padding: "20px 24px" }}>
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 20 }}>
              ...
              <button onClick={() => setSelectedApp(null)} style={{ background: "none", border: "none", cursor: "pointer", color: t.muted }} aria-label="Close application details" title="Close application details">
                <XIcon />
              </button>
            </div>
        ...
        <Modal onClose={() => setEditApp(null)} t={t}>
          <div style={{ padding: "20px 24px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
              ...
              <button onClick={() => setEditApp(null)} style={{ background: "none", border: "none", cursor: "pointer", color: t.muted }} aria-label="Close edit application modal" title="Close edit application modal"><XIcon /></button>
            </div>
        ...
        <Modal onClose={() => setShowSettings(false)} t={t}>
          <div style={{ padding: "20px 24px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
              ...
              <button onClick={() => setShowSettings(false)} style={{ background: "none", border: "none", cursor: "pointer", color: t.muted }} aria-label="Close settings" title="Close settings"><XIcon /></button>
            </div>
