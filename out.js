      ...
      children: [
          ...
          /* @__PURE__ */ jsxs("section", { style: { marginBottom: 52 }, children: [
            ...
            (filterStage !== "all" || sortField !== "none") && /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 6, marginBottom: 12, flexWrap: "wrap" }, children: [
              filterStage !== "all" && /* @__PURE__ */ jsxs("span", { style: {
                ...
                /* @__PURE__ */ jsx("button", { onClick: () => setFilterStage("all"), style: { background: "none", border: "none", cursor: "pointer", color: "inherit", padding: 0, lineHeight: 1 }, "aria-label": "Clear filter", title: "Clear filter", children: "\xD7" })
              ] }),
              sortField !== "none" && /* @__PURE__ */ jsxs("span", { style: {
                ...
                " ",
                sortDir === "asc" ? "\u2191" : "\u2193",
                /* @__PURE__ */ jsx("button", { onClick: clearSort, style: { background: "none", border: "none", cursor: "pointer", color: "inherit", padding: 0, lineHeight: 1 }, "aria-label": "Clear sort", title: "Clear sort", children: "\xD7" })
              ] })
            ] }),
        ...
        selectedApp && !editApp && /* @__PURE__ */ jsx(Modal, { onClose: () => setSelectedApp(null), t, children: /* @__PURE__ */ jsxs("div", { style: { padding: "20px 24px" }, children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 20 }, children: [
            ...
            /* @__PURE__ */ jsx("button", { onClick: () => setSelectedApp(null), style: { background: "none", border: "none", cursor: "pointer", color: t.muted }, "aria-label": "Close application details", title: "Close application details", children: /* @__PURE__ */ jsx(XIcon, {}) })
          ] }),
        ...
        editApp && /* @__PURE__ */ jsx(Modal, { onClose: () => setEditApp(null), t, children: /* @__PURE__ */ jsxs("div", { style: { padding: "20px 24px" }, children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }, children: [
            ...
            /* @__PURE__ */ jsx("button", { onClick: () => setEditApp(null), style: { background: "none", border: "none", cursor: "pointer", color: t.muted }, "aria-label": "Close edit application modal", title: "Close edit application modal", children: /* @__PURE__ */ jsx(XIcon, {}) })
          ] }),
        ...
        showSettings && /* @__PURE__ */ jsx(Modal, { onClose: () => setShowSettings(false), t, children: /* @__PURE__ */ jsxs("div", { style: { padding: "20px 24px" }, children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }, children: [
            ...
            /* @__PURE__ */ jsx("button", { onClick: () => setShowSettings(false), style: { background: "none", border: "none", cursor: "pointer", color: t.muted }, "aria-label": "Close settings", title: "Close settings", children: /* @__PURE__ */ jsx(XIcon, {}) })
          ] }),
          [
...
root.render(/* @__PURE__ */ jsx2(DemoOne, {}));
