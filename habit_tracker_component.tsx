        ...
        <Modal title="Add Habit Column" onClose={() => setShowAddColumnModal(false)} dark={dark}>
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-1">
              ...
              <button onClick={handleAddColumn} disabled={!newColLabel.trim()} title={!newColLabel.trim() ? "Column label is required" : undefined} className={primaryBtn}>Add Column</button>
            </div>
          </div>
        </Modal>
      )}
