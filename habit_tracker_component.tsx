              ...
              <div className="flex items-center gap-1 flex-wrap">
                ...
                <div className="relative" ref={filterRef}>
                  <button onClick={() => { setShowFilterMenu(!showFilterMenu); setShowSortMenu(false); }}
                    aria-label="Filter habits" title="Filter habits"
                ...
                <div className="relative" ref={sortRef}>
                  <button onClick={() => { setShowSortMenu(!showSortMenu); setShowFilterMenu(false); }}
                    aria-label="Sort habits" title="Sort habits"
                ...
                <button onClick={() => { setShowSearch(!showSearch); if (showSearch) setSearchQuery(""); }}
                  aria-label="Search habits" title="Search habits"
        ...
        <Modal title="Add Habit Column" onClose={() => setShowAddColumnModal(false)} dark={dark}>
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-1">
              ...
              <button onClick={handleAddColumn} disabled={!newColLabel.trim()} title={!newColLabel.trim() ? "Enter a column name to add" : undefined} className={primaryBtn}>Add Column</button>
            </div>
          </div>
        </Modal>
      )}
        ...
        <Modal title="Add New Row" onClose={() => setShowNewRowModal(false)} dark={dark}>
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-1">
              ...
              <button onClick={handleAddRow} disabled={!newRowDay.trim()} title={!newRowDay.trim() ? "Enter a label to add" : undefined} className={primaryBtn}>Add Row</button>
            </div>
          </div>
        </Modal>
      )}
