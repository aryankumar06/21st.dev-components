                    ...
                    <th key={col.key} className={cn("text-left px-5 py-3 text-[12px] font-medium border-r group relative", t.subtext, t.cellBorder)}>
                      <div className="flex items-center gap-1.5">
                        ...
                        <button
                          ...
                          className={cn("ml-1 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 p-0.5 rounded transition-all", t.iconBtn)}
                        >
                    ...
                    <tr key={row.day} className={cn("border-b transition-colors duration-150 group", t.border, t.rowHover)}>
                      ...
                      <td className={cn("px-4 py-3.5 border-r text-center", t.cellBorder)}>
                        <button onClick={() => handleCheckAllForDay(row.day)} title="Check all for this day" aria-label={`Check all for ${row.day}`}
                          className={cn("opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 p-1 rounded transition-all", t.iconBtn, t.muted)}>
