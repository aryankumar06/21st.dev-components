              ...
              <div className="space-y-1.5">
                {columns.map((col) => (
                  <div key={col.key} className={cn("flex items-center justify-between px-3 py-2.5 rounded-lg border", t.settingRow)}>
                    ...
                    <div className="flex items-center gap-1">
                      <button onClick={() => handleToggleColumnVis(col.key)} aria-label={col.visible ? "Hide column" : "Show column"} title={col.visible ? "Hide" : "Show"}
                      ...
                      <button onClick={() => handleDeleteColumn(col.key)} aria-label="Delete column" title="Delete column"
